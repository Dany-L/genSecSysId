...
min_ = -0.1; max_ = -min_; num_samples = 200;
...
for i=1:M
    ...
    if x0'*X*x0 + norm(d,2) > s^2
        ...
        plot(x(1,1:2), x(2,1:2), 'LineWidth', 1.5)
        counter = counter +1;
...
exportgraphics(gca, './matlab/plots/with external inputs/invariance.pdf');
